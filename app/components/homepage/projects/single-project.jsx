...
const SingleProject = ({ project }) => {
  ...
  return (
    <div className="group w-full flex flex-col items-center justify-center relative cursor-text overflow-hidden px-3 md:px-8 py-8 bg-[linear-gradient(90deg,#281e57_0%,#201435_100%)] shadow-2xl rounded-lg border border-[#1a1443] transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-1 mb-8">
      ...
      <div className='flex flex-col items-center justify-between w-full h-full'>
        ...
        <div className="p-6">
          <Image
            ...
            width={1080}
            height={710}
            className="w-full h-64 transition-opacity duration-[0.7s] delay-[0.3s] rounded-lg"
          />
        </div>
        <div className="flex flex-col items-center justify-between w-full space-y-4 px-6">
          <p className="text-sm md:text-base text-center text-[#EFF3F4]">
            {description}
          </p>
      ...
      <div className='absolute bottom-0 w-full text-[0.8rem] flex justify-center gap-2 flex-col transition-transform duration-[0.5s] delay-[0.3s] p-[0.825rem] text-[#EFF3F4]'>
        {tags.map((tag, id) => (
